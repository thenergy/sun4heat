...
# -*- coding: utf-8 -*-
"""
Created on Sun Jan 31 15:15:11 2021
...
#import sys
#sys.path
##sys.path.append('/home/ubuntu/mapa_industrial/scripts')
#sys.path.append('/Users/fcuevas/Documents/Trabajo/thenergy/mapa_industrial/scripts')
...
df_results = pd.read_excel('EscondidaDailyValues.xlsx',skiprows=range(1,2))
...
resumen['solarSF_MWh'] = resumen['Solar Direct'] * 24
resumen['solarST_MWh'] = resumen['Solar Storage'] * 24
resumen['solar_MWh'] = resumen.solarSF_MWh + resumen.solarST_MWh
resumen['P2H_MWh'] = resumen['P2H'] * 24
...
res_vars = ['Demanda','Solar','P2H','Dissipation', 'Solar Fraction']
menuRes=list(res_vars)
dropdownRes = Select(value='Solar', title="Resultado",options=menuRes,width=300) 
...
columns = [
    ...
    TableColumn(field="diesel_m3", title="Consumo m3", formatter=NumberFormatter(format="0.0")),
